...
contract Onidex is ERC721 {
  ...
  // map nft's token id to crypto boy
  ...
  constructor() ERC721("Onidex Collection", "ONI") {
    collectionName = name();
  ...
  function buyToken(uint256 _tokenId) public payable {
    ...
    // get that token from all crypto boys mapping and create a memory of it defined as (struct => nft)
